...
class ECE:
    def __init__(self, format: str, exclude_not_attempted: bool, n_bins: int = 10):
        self.format = format
    ...
    def compute_ece(self, accuracies, confidences):
        ...
        for bin_lower, bin_upper in zip(bin_lowers, bin_uppers):
            in_bin = np.logical_and(confidences >= bin_lower, confidences <= bin_upper) # Changed > to >= for bin_lower
